...
const FAQs = () =>{
    return(
        <ul className={styles.container}>
            ...
            <li>
                <h4 className={styles.question}>How Long Will It Take to Hear Back From The Adoption Group?</h4>
            ...
            <li>
                <h4 className={styles.question}>How Will I Know If I’ve Been Approved to Adopt a Pet?</h4>
            ...
            <li>
                <h4 className={styles.question}>Am I Applying to be a member?</h4>
            ...
            <li>
                <h4 className={styles.question}>Does Contacting the Adoption Group Put The Pet on Hold?</h4>
            ...
            <li>
                <h4 className={styles.question}>Will There Be An Adoption Fee?</h4>
            ...
            <li>
                <h4 className={styles.question}>Why Wasn’t I Selected to Adopt?</h4>
            ...
            <li>
                <h4 className={styles.question}>For more Question, Please <Link className={styles.link} to='/ContactUS'>contact us</Link> directly.</h4>
            </li>
        </ul>
    )
}
